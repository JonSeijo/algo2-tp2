...
\begin{algorithm}[H]{\textbf{coordenadaArriba}(\In{c}{coor}) $\to$ $res$ : coor}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]{\textbf{coordenadaAbajo}(\In{c}{coor}) $\to$ $res$ : coor}
\begin{algorithmic}[1]
	\State $res$ $\gets$  $\langle$ Latitud($c$) $-$ 1 , Longitud($c$) $\rangle$ \Comment $O(1)$
...
\begin{algorithm}[H]{\textbf{coordenadaALaDerecha}(\In{c}{coor}) $\to$ $res$ : coor}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]{\textbf{coordenadaALaIzquierda}(\In{c}{coor}) $\to$ $res$ : coor}
\begin{algorithmic}[1]
	\State $res$ $\gets$  $\langle$ Latitud($c$) , Longitud($c$) $-$ 1  $\rangle$ \Comment $O(1)$
