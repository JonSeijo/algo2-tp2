...
1) Todos los vectores que forman la grilla son del mismo tam $ $\newline
2) tam es consistente con el tam de la grilla $ $\newline
3) Si vale grilla[x][y][z][w] vale tambien grilla[z][w][x][y] $ $\newline
4) Si C no esta en la grilla, entonces no tiene camino con ninguna $ $\newline
5) Si C no esta en la grilla, entonces ninguna tiene camino con C $ $\newline
6) Si C y C' son contiguas y ambas estan en la grilla, entonces hay camino entre ellas $ $\newline
7) Si hay camino entre C y C', y hay camino entre C' y C'' entonces hay camino entre C y C'' $ $\newline
8) Si hay camino entre C y C', y NO hay camino entre C' y C'' entonces NO hay camino entre C y C'' $ $\newline
