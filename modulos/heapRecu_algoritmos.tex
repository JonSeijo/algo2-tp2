...
% \begin{algorithm}[H]
% {\textbf{iSwapNodos}(\Inout{na}{nodo}, \Inout{nb}{nodo}) $\to$ $res$ : bool}
% \begin{algorithmic}[1]

%     % Me guardo los nodos que voy a sobreescribir
...
%     % Ahora quiero meter nb en na (porque me guarde los datos de na)
