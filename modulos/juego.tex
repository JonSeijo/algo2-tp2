...
\begin{Tupla}[pokgo]  
	...
	\tupItem{\\ cantPokemonTotal}{nat} % Para acceso O(1) al total
...
\State nat $cantPokemonTotal \gets $ 0  \Comment $O(1)$
$ $\newline
...
\State $res \gets \langle cantPokemon$, $cantPokemonTotal$, $map$, $jugs$, $grillaJugs$, $pokenodos \rangle$   \Comment $O(1)$
